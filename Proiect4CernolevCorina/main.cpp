...
int Minim(int l, int k, int a[NMAX][NMAX]);
// functia returneaza valoarea maxima
int Maxim(int l, int k, int a[NMAX][NMAX]);
...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            cout << "\n Varsta cea mai mare este " << Minim(l, k, varsta);
            cout << "\n Varsta cea mai mica este " << Maxim(l, k, varsta) << endl;
            break;
        case 2:
            Afisare(l, k, varsta, "initial");
